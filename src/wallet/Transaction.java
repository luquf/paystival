...
public class Transaction {
	...
	private byte[] from;			/* 4 bytes, 0xffffffff means this is a credit from the festival */
	private byte[] to;				/* 4 bytes, 0xffffffff means this is a debit from the festival */
